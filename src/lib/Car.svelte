<script>
  ...
  function createScene() {
    ...
    Composite.add(
      world,
      genCar(550, 100, 250 * scale, 10 * scale, 30 * scale)
    );
    Composite.add(
      world,
      genCar(150, 100, 150 * scale, 10 * scale, 50 * scale)
    );
   
    scale = 0.8;
    Composite.add(
      world,
      genCar(350, 300, 150 * scale, 30 * scale, 30 * scale)
    );
  ...
  function genCar (xx, yy, width, height, wheelSize) {
